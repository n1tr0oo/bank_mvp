...
├── .dockerignore
├── README.md                  # этот файл
└── P6_Makhan_Azat.md          # отчёт по Заданию 1 практической работы
```

**Задание 2 (AI-ассистированная версия)** вынесено в отдельную папку [`../mvp_part2/mvp_ai/`](../mvp_part2/) вместе с отчётом `P6_Task2_Makhan_Azat.md` и связанными scan-отчётами — оно использует другой стек (Flask + SQLite) и отдельный жизненный цикл.
